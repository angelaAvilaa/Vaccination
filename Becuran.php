...
$queryAccount = "SELECT * FROM becuran WHERE Vaccine LIKE '%$searchTerm%' OR ChildAge LIKE '%$searchTerm%'";
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <!-- Search Form -->
            <form action="BecuranTbl.php" method="post" class="form-inline" style="margin-top: 20px;">
                <input type="text" name="searchTerm" placeholder="Search by ChildAge" class="form-control" required />
