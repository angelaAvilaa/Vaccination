...
$queryAccount = "SELECT * FROM san_juan WHERE Vaccine LIKE '%$searchTerm%' OR ChildAge LIKE '%$searchTerm%'";
        ...
        if (mysqli_num_rows($sqlAccount) > 0) {
            while ($results = mysqli_fetch_array($sqlAccount)) { ?>
                <tr>
                    ...
                    <td>
                        <form action="Edit3.php" method="post" style="display:inline;">
                        ...
                        <form action="Delete3.php" method="post" style="display:inline;">
