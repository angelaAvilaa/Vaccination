...
require('./Read.php'); // Ensure Read.php contains the correct database connection
...
$queryAccount = "SELECT * FROM childregistration WHERE Vaccine LIKE '%$searchTerm%' OR ChildAge LIKE '%$searchTerm%'";
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <!-- Search Form -->
            <form action="AdminPage.php" method="post" class="form-inline" style="margin-top: 20px;">
                <input type="text" name="searchTerm" placeholder="Search by Vaccine or ChildAge" class="form-control" required />
